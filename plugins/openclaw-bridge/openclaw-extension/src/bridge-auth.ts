...
export function getBridgeClientCapabilities(extraCapabilities: string[] = []): string[] {
 if (!nativeFileSupport) {
  try {
   ...
   nativeFileSupport = ["clawchat.agent_files.v1", "clawchat.native_operation_barrier.v1", "clawchat.agent_profile.v1", "clawchat.agent_removal.v1", "clawchat.native_cron.v1"];
